...
import { createGasto, findCategory } from "../utils/functions";
...
const InserirGasto = () => {
  ...
  const handleClickButton = () => {
    createGasto(autor, categoria, desc, valor);
    route.push("/");
  };
  ...
  return (
    <div>
      <Header />
      <h2 className="mx-4 text-xl"> Lançamento de Gastos </h2>
      <div>
        <div className="m-5">
